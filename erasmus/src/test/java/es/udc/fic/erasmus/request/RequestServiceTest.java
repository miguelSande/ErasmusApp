...
public class RequestServiceTest extends WebAppConfigurationAware {
	...
	private Student createStudent(Double note, String others, String language, Boolean lang_test) {
		Student student = new Student("john doe", note, others, language, lang_test);
	...
	public void testCreate() {
		Student student = createStudent(6.25, null, "EN - B1", false);
	...
	public void testLanguage() {
		Student student1 = createStudent(6.25, null, "EN - B2", null);
		Student student2 = createStudent(6.25, null, "EN - B1", null);
		Student student3 = createStudent(6.25, null, "EN - A2", null);
		Student student4 = createStudent(6.25, null, null, true);
		Student student5 = createStudent(6.25, null, null, false);
		Student student6 = createStudent(6.25, null, null, null);
	...
	public void testProcessBothAccepted() {
		Student student1 = createStudent(6.25, "cosa", "EN_A2", null);
		Student student2 = createStudent(5.25, null, "EN_A2", null);
	...
	public void testProcessRejectedLanguage() {
		Student student1 = createStudent(6.25, "cosa", "EN_B2", null);
		Student student2 = createStudent(5.25, null, null, null);
	...
	public void testProcessSimpleAcepted() {
		Student student = createStudent(5.25, null, null, null);
		Student student2 = createStudent(5.00, null, "EN - B2", null);
	...
	public void testProcessRejectedSecondOption() {
		Student student1 = createStudent(6.25, "cosa", "EN_B2", null);
		Student student2 = createStudent(5.25, null, "EN_B2", null);
		University university = createUni(Language.EN_B1, 2L);
		Request rq = new Request(student1, university, 1L, "f");
		rq = rqService.create(rq);
		Request rq2 = new Request(student2, university, 1L, "f");
	...
	public void testProcessRejectedOutOfPosts() {
		Student student1 = createStudent(6.25, "cosa", "EN_B2", null);
		Student student2 = createStudent(5.25, null, "EN_B2", null);
		Student student3 = createStudent(5.00, null, "EN_B2", null);
		University university = createUni(Language.EN_B1, 2L);
		Request rq = new Request(student1, university, 1L, "f");
		rq = rqService.create(rq);
		Request rq2 = new Request(student2, university, 1L, "f");
		...
		assertEquals(State.ACCEPTED, rq2.getState());
		assertEquals(State.REJECTED,rq3.getState());
		assertEquals("Prazas agotadas", rq3.getMotive());
		stRepo.delete(student1);
		stRepo.delete(student2);
		stRepo.delete(student3);
		uniRepo.delete(university);
